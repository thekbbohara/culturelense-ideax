...
export function Nav() {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-[999] bg-primary backdrop-blur-xl border-b border-primary/10 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'
        }`}
    >
