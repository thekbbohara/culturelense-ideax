...
export function NavSearch() {
  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
       <div className={`relative flex items-center bg-neutral-black/5 rounded-full px-4 py-2 transition-all border ${isFocused ? 'bg-white border-primary shadow-lg ring-4 ring-primary/5' : 'border-black/10 hover:bg-neutral-black/10'}`}>
