      ...
      {!hasHistory ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] relative">
          ...
          >
            ...
            <div className="absolute -right-32 top-1/2 -translate-y-1/2 hidden lg:block">
              <div className="flex items-center gap-4">
                ...
                <span className="font-handwriting text-neutral-black/40 text-sm rotate-6">
          ...
          <div className="mt-12 text-center">
            <p className="text-sm font-bold uppercase tracking-widest text-neutral-black/30 mb-4">
              Or manually search
            </p>
            <div className="flex gap-4">
              <Button
                variant="outline"
                className="rounded-full border-neutral-black/10 px-8 h-12 hover:bg-neutral-black hover:text-white transition-colors"
              >
              ...
              {[
                ...
                >
                  ...
                  <div className="px-2 pb-2">
                    <span className="text-[10px] font-black uppercase tracking-widest text-secondary block mb-2">
                      {item.tag}
                    </span>
