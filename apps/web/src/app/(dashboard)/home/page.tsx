              ...
              {isLoading ? (
                <div className="flex gap-4 overflow-x-auto pb-4 sm:pb-0 scrollbar-hide sm:flex-wrap max-w-[calc(100vw-3rem)]">
                  {[1, 2, 3].map((_, i) => (
                    <div
                      key={i}
                      className="min-w-[75vw] sm:min-w-0 shrink-0 sm:shrink sm:basis-[calc(50%-0.75rem)] lg:basis-[calc(33.33%-1.07rem)] aspect-[4/3] rounded-[2rem] overflow-hidden border border-primary/5 bg-white shadow-sm"
                    >
