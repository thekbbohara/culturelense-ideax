              ...
              <div className="text-center lg:text-left space-y-6">
                ...
                >
                  ...
                  <p className="mt-4 text-stxt text-lg lg:text-xl max-w-md mx-auto lg:mx-0">
                    Point your camera at art, statues, or symbols to instantly identify deities and
              ...
              <div className="relative flex items-center justify-center">
                ...
                >
                  ...
                  <div className="mt-8 text-center lg:hidden">
                    <h2 className="text-2xl font-serif font-black italic mb-2 text-txt">
                      Tap to Scan
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-fr">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 p-8 w-full">
                      ...
                      <h3 className="text-3xl lg:text-5xl font-serif font-bold text-white mb-2">
              ...
              {isRecommendedLoading && hasHistory ? (
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-6">
                  {[1, 2, 3, 4, 5].map((_, i) => (
                    <Card
                      key={i}
                      className="p-4 rounded-[2rem] bg-card border border-border h-full shadow-none"
                    >
                        ...
                        >
                          <div className="aspect-square relative rounded-2xl overflow-hidden mb-4 bg-muted">
                            {item.imageUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-xs text-stxt">
                                No Image
                              </div>
                            )}
                          ...
                          <div className="px-1 pb-1">
                            <span className="text-[10px] font-black uppercase tracking-widest text-secondary block mb-1.5">
                              {item.type}
                            </span>
                            <h3 className="font-serif font-bold text-lg text-txt leading-tight group-hover:text-primary transition-colors">
                              {item.name}
                            </h3>
                          </div>
                        </Card>
