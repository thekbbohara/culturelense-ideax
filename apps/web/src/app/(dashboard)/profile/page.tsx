      ...
      <div className="relative z-10 container mx-auto pt-16 pb-32 px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <section>
              <div className="flex items-baseline justify-between mb-6">
                <h3 className="text-xl font-light flex items-center gap-2">
                  Acquisitions
                  <span className="text-xs align-top bg-muted text-muted-foreground px-2 py-0.5 rounded-full font-mono">
                    {recentOrders.length}
                  </span>
                </h3>
                <Link
              ...
              <div className="bg-card border rounded-xl overflow-hidden shadow-sm">
                {recentOrders.length > 0 ? (
                  recentOrders.map((order, i) => (
                    <div
                      key={order.id}
                      className="group flex flex-col sm:flex-row sm:items-center justify-between p-5 border-b last:border-0 hover:bg-muted/50 transition-colors cursor-pointer"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="font-medium text-foreground group-hover:translate-x-1 transition-transform duration-300">
                            {order.item}
                          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            {user && <ProfileSettings userId={user.id} initialPreferences={preferencesData} />}
